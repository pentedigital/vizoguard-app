...
contextBridge.exposeInMainWorld("vizoguard", {
  ...
  onThreatBlocked: (cb) => ipcRenderer.on("threat:blocked", (_e, d) => cb(d)),
  onConnectionsUpdate: (cb) => ipcRenderer.on("connections:update", (_e, d) => cb(d)),
  onImmuneAlert: (cb) => ipcRenderer.on("immune:alert", (_e, d) => cb(d)),
